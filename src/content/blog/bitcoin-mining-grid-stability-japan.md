...
This process has [prevented blackouts](https://www.texastribune.org/2024/07/10/texas-bitcoin-mine-noise-power-grid-cryptocurrency/). It also reduces the need for fossil-fuel "peaker" plants. Peaker plants are expensive. They run only a few hours a year. They are often inefficient. **Mining** provides a cleaner, faster, and more flexible alternative.
...
The second partner is the "unnamed major regional utility." **Japan** has only ten such utilities. All are state-linked monopolies. The one that has previously piloted **Bitcoin Mining** is TEPCO (Tokyo Electric Power Company). In 2024, TEPCO's subsidiary, [Agile Energy X](https://agileenergyx.co.jp/en/), tested mining.


TEPCO is widely known as the operator of the Fukushima Daiichi power plant. As a result, the company [has faced extensive public scrutiny](https://www.tepco.co.jp/en/nu/fukushima-np/review/index-e.html) regarding its transparency. This context makes any new, innovative project from a Japanese utility a subject of high public interest. This is especially true when it involves**Mining**.
