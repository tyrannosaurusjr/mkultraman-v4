...
This is a developing story, and you can read the original report from [TechCrunch](https://techcrunch.com/2025/10/06/openai-launches-apps-inside-of-chatgpt/). For more analysis on platform strategy, [Wired's](https://www.wired.com/story/apple-app-store-platform-power/) coverage of other tech ecosystems provides excellent context. OpenAI has also posted details on its [official company blog](https://en.wikipedia.org/wiki/OpenAI).
